package com.kassmon.game.ui.console.interactiveCodingConsole;
...
public class InteractiveCodingConsole extends JInternalFrame implements UIComponent {
	...
	public InteractiveCodingConsole(String name, int id) {
		initConsole();
		resizeConsole();
		this.name = name;
		this.id = id;
